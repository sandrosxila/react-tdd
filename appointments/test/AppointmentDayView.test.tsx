...
import { createContainer, Container } from './domManipulators';
import {
    Appointment,
    AppointmentsDayView,
    Customer
...
describe('AppointmentsDayView', () => {
    ...
    const appointments = [
        ...
        },
        {
            ...
            customer: { firstName: 'Jordan', lastName:'', phoneNumber: '' },
            stylist: '',
            service: '',
            notes: ''
        }
    ];
    let render: Container['render'], container: Container['container'], element: Container['element'], elements: Container['elements'], click: Container['click'];
    ...
    it('has a button element in each li', () => {
        ...
        expect(elements<HTMLButtonElement>('li > button')[0].type).toEqual('button');
    });
